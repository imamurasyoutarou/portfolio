        ...
        <Grid>
          <Cell col={4}>
            ...
            <p>
              ...
              <p>
                デザイン会社でフロントエンドとデザイナーとして働いたこと経験があり、デザインとエンジニアリングの双方を意識した円滑に開発を行うことができます。デザイナーとエンジニアの架け橋に慣れるような人材を目指してます。
              </p>
              <p style={{ fontWeight: "bold" }}>
                ・ユーザー体験を深く意識し開発
              </p>
...
HTML CSS JavaScript sketch"
              jobDescription="基本的なデザインツールの使用方法・仮想案件をしながらデザインツールの使用方法、UIの考え方を身に着けることができました。スタートアップ をメインに低単価でUI改善を行う新規事業の営業資料を作成し、
              自分で営業を行いその営業資料のデザインに対してのターゲットユーザーの反応をみた上でブラッシュアップを繰り返す上で営業を行っていました。"
            />
            <Experience
              startYear={2019.9}
              endYear={2019.11}
