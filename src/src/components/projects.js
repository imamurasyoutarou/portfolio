            ...
            return (
                <div className="projects-grid">
                    ...
                    <Card shadow={5} style={{ minWidth: '450', margin: 'auto', textAlign: 'center' }}>
                        ...
                        <CardText>
                            SPAのポートフォリオです！レスポンシブ対応
                    </CardText>
                        <CardActions border>
                            <a href="https://github.com/imamurasyoutarou/Myportfolio"><Button colored>Gidhub</Button></a>
                        </CardActions>
                        <CardMenu style={{ color: '#fff' }}>
                            <IconButton name="share" />
                        </CardMenu>
